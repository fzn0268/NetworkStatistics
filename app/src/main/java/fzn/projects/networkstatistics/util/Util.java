...
public class Util {
     ...
     * @return 转换后的字符串
     */
    public static String byteConverter(long bytes, boolean isSpeed, String format) {
    ...
    public static String[] byteConverterUnitSplit(long bytes, boolean isSpeed, String format) {
        df.applyPattern(format);
        if (bytes > 0x40000000)
    ...
    public static short[] resolveComboPeriod(String period) {
     ...
     */
    public static byte[] splitTime(String time) {
