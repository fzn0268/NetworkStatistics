...
public final class NetworkStatisticsContract {
	...
	public static abstract class ComboEntry implements BaseColumns {
		...
		public static final String COLUMN_NAME = "ComboName";
		public static final String COLUMN_NAME_TYPE = "TEXT";
		public static final String COLUMN_CONN = "Conn";
		public static final String COLUMN_CONN_TYPE = "INTEGER NOT NULL";
		public static final String COLUMN_PRIORITY = "Priority";
		public static final String COLUMN_PRIORITY_TYPE = "INTEGER NOT NULL";
		...
		public static final String COLUMN_TIME_INTERVAL_FROM = "TimeDurationFrom";
		public static final String COLUMN_TIME_INTERVAL_FROM_TYPE = "TEXT";
		public static final String COLUMN_TIME_INTERVAL_TO = "TimeDurationTo";
		public static final String COLUMN_TIME_INTERVAL_TO_TYPE = "TEXT";
